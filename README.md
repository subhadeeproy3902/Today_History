...
## Year - 2004
 [President of South Korea](https://wikipedia.org/wiki/President_of_South_Korea "President of South Korea"), [Roh Moo-hyun](https://wikipedia.org/wiki/Roh_Moo-hyun "Roh Moo-hyun"), is impeached by its [National Assembly](https://wikipedia.org/wiki/National_Assembly_(South_Korea) "National Assembly (South Korea)"), the first such [impeachment](https://wikipedia.org/wiki/Impeachment "Impeachment") in the nation's history.
...
## Year - 1989
 [Tim Berners-Lee](https://wikipedia.org/wiki/Tim_Berners-Lee "Tim Berners-Lee") submits his proposal to [CERN](https://wikipedia.org/wiki/CERN "CERN") for an information management system, which subsequently develops into the [World Wide Web](https://wikipedia.org/wiki/World_Wide_Web "World Wide Web").
...
## Year - 1942
 The [Battle of Java](https://wikipedia.org/wiki/Battle_of_Java_(1942) "Battle of Java (1942)") ends with the surrender of the [American-British-Dutch-Australian Command](https://wikipedia.org/wiki/American-British-Dutch-Australian_Command "American-British-Dutch-Australian Command") to the [Empire of Japan](https://wikipedia.org/wiki/Empire_of_Japan "Empire of Japan") in [Bandung](https://wikipedia.org/wiki/Bandung "Bandung"), [West Java](https://wikipedia.org/wiki/West_Java "West Java"), [Dutch East Indies](https://wikipedia.org/wiki/Dutch_East_Indies "Dutch East Indies").
...
## Year - 1862
 Paddle steamer [Brother Jonathan](https://wikipedia.org/wiki/Brother_Jonathan_(steamer) "Brother Jonathan (steamer)") docks in [Fort Victoria](https://wikipedia.org/wiki/Fort_Victoria_(British_Columbia) "Fort Victoria (British Columbia)") (now [Victoria, British Columbia](https://wikipedia.org/wiki/Victoria,_British_Columbia "Victoria, British Columbia")), carrying [smallpox](https://wikipedia.org/wiki/Smallpox "Smallpox") infected passengers from [San Francisco](https://wikipedia.org/wiki/San_Francisco "San Francisco"). The ensuing [epidemic](https://wikipedia.org/wiki/1862_Pacific_Northwest_smallpox_epidemic "1862 Pacific Northwest smallpox epidemic") killed an estimated two thirds of [First Nations in the province of British Columbia](https://wikipedia.org/wiki/First_Nations_in_British_Columbia "First Nations in British Columbia").
...
## Year - 1391
 [Konrad von Wallenrode](https://wikipedia.org/wiki/Konrad_von_Wallenrode "Konrad von Wallenrode") is elected the 24th [Grand Master of the Teutonic Order](https://wikipedia.org/wiki/Grand_Master_of_the_Teutonic_Order "Grand Master of the Teutonic Order") (date is [O.S.](https://wikipedia.org/wiki/Julian_calendar "Julian calendar")).

## Year - 1158
 German city Munich (München) is first mentioned as <i>forum apud Munichen</i> in the [Augsburg arbitration](https://wikipedia.org/wiki/Augsburg_arbitration "Augsburg arbitration") by Holy Roman Emperor [Friedrich I](https://wikipedia.org/wiki/Frederick_Barbarossa "Frederick Barbarossa").
...
> _Last Updated: 3/12/2026, 3:29:46 PM (in GMT)_
